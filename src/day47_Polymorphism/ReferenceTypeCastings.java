...
public class ReferenceTypeCastings {
    ...
    public static void main(String[] args) {
        ...
        //   Dog dog = (Dog)animal; // downcasting   //if you use more than once
        //  dog.bark();

        System.out.println( animal.getName() );
        // System.out.println( dog.getName() );

        (  (Dog)animal  ).bark();   //if you not use more than once


        Shape shape1 = new Square(5);

        System.out.println( ((Square) shape1).getSide()  );   //shortcut: click red lamb left side and choose cast
